...
I worked alongside FAIR researchers in the development of the [Open Catalyst 2020 Dataset](https://opencatalystproject.org/) (OC20), an effort to enable the development of robust, accurate models for catalyst exploration. Additionally, I spent a summer as a Research intern at [FAIR](https://ai.facebook.com/) (2020), working with [Larry Zitnick](https://research.fb.com/people/zitnick-larry/) and [Devi Parikh](https://research.fb.com/people/parikh-devi/) on applying graph neural networks to model atomic interactions.
